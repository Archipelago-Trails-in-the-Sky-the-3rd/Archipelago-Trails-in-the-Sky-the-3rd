...
class TitsThe3rdMemoryIO():
    ...
    def give_all_sepith(self, low_element_amount: int, high_element_amount: int):
        ...
        self.tits_the_3rd_mem.write_bytes(address + 93, bytes(f"{low_element_amount:03d}", encoding="utf8"), 4)
        self.tits_the_3rd_mem.write_bytes(address + 116, bytes(f"{low_element_amount:03d}", encoding="utf8"), 4)
        self.tits_the_3rd_mem.write_bytes(address + 138, bytes(f"{low_element_amount:03d}", encoding="utf8"), 4)
        self.tits_the_3rd_mem.write_bytes(address + 160, bytes(f"{low_element_amount:03d}", encoding="utf8"), 4)
        self.tits_the_3rd_mem.write_bytes(address + 182, bytes(f"{high_element_amount:03d}", encoding="utf8"), 4)
        self.tits_the_3rd_mem.write_bytes(address + 205, bytes(f"{high_element_amount:03d}", encoding="utf8"), 4)
        self.tits_the_3rd_mem.write_bytes(address + 229, bytes(f"{high_element_amount:03d}", encoding="utf8"), 4)
