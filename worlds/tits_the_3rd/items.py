...
consumable_table: Dict[str, TitsThe3rdItemData] = {
    ...
    ItemName.fluffy_crepe: TitsThe3rdItemData(444, ItemClassification.filler),
    ItemName.queenly_cookie: TitsThe3rdItemData(480, ItemClassification.filler),
    ItemName.septium_drops: TitsThe3rdItemData(483, ItemClassification.filler),
    ...
    ItemName.curia_balm: TitsThe3rdItemData(507, ItemClassification.filler),
